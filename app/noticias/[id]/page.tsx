    ...
    <main className="bg-bg pt-20 text-text">
      <article className="mx-auto max-w-5xl px-4 pb-24 pt-10 sm:px-6 lg:px-8">
        ...
        <header className="mt-8">
          <span className="rounded-lg bg-bg-elevated px-3 py-1 text-xs font-black uppercase tracking-[0.12em] text-accent shadow-sm">
            {item.category}
          </span>
          <h1 className="mt-5 text-[clamp(3rem,14vw,6rem)] font-black leading-[0.88] tracking-tight">
            {item.title}
          </h1>
