...
export default function ContactoPage() {
  return (
    <div className="bg-bg pt-28 transition-colors">
      <section className="mx-auto max-w-6xl px-4 pb-24 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow="Proceso de ingreso"
          title="Inscripción"
          description="Ingreso al proceso deportivo, social y formativo de Real Sporting de Usme, construido desde el proyecto CDRS 2026 y el modelo de entrenamiento SCM."
          align="center"
        />

        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          <section className="rounded-lg border border-border bg-bg-elevated p-6 transition-colors sm:p-8">
        ...
        <section className="mt-12">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {programCards.map(({ title, text, icon: Icon }) => (
              <article
                key={title}
                className="rounded-lg border border-border bg-bg-elevated p-5 transition-colors hover:border-accent/30"
              >
        ...
        <section className="mt-12">
          ...
          <div className="mx-auto mt-8 max-w-xl rounded-lg border border-border bg-bg-elevated p-8 text-center transition-colors">
