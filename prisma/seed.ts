...
async function main() {
  ...
  const wonTournaments = [
    ...
    },
    {
      ...
      programacion: "Semifinal: 3-1 vs Categoría U-15\nFinal: 2-0 vs Categoría U-16",
  ...
  const futureTournaments = [
    {
      ...
      descripcion: "Participación confirmada en la copa nacional. Oportunidad de competir a nivel nacional.",
    ...
    },
    {
      ...
      descripcion: "Posible participación en torneo sudamericano. Competencia internacional de gran nivel.",
    ...
    },
    {
      ...
      descripcion: "Torneo amistoso para cerrar la temporada. Preparación para próxima temporada.",
  ...
  console.log(`Total: ${playedTournaments.length + wonTournaments.length + futureTournaments.length} torneos creados\n`);
}
