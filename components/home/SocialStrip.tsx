...
export function SocialStrip() {
  return (
    <section className="section-ambient border-y border-border bg-bg-elevated/50">
      <div className="mx-auto flex max-w-6xl flex-col items-stretch gap-3 px-4 py-6 sm:flex-row sm:flex-wrap sm:items-center sm:justify-center sm:gap-10 sm:px-6 sm:py-8 lg:px-8">
        ...
        <a
          ...
          className="alive-lift flex shrink-0 items-center gap-2 rounded-full border border-border bg-bg px-4 py-2 text-sm font-semibold text-muted transition-colors hover:text-text sm:border-0 sm:bg-transparent sm:px-0 sm:py-0"
        >
        ...
        <Link
          href="/contacto"
          className="alive-lift shrink-0 rounded-full border border-accent/30 bg-accent/10 px-4 py-2 text-sm font-bold text-accent hover:text-accent-secondary sm:border-0 sm:bg-transparent sm:px-0 sm:py-0"
        >
          Página de contacto →
        </Link>
      </div>
