...
function WhatsAppIcon() {
  return (
    <svg viewBox="0 0 24 24" className="size-6 shrink-0 fill-current sm:size-7" aria-hidden="true">
...
export function WhatsAppFloat() {
  ...
  return (
    ...
    >
      <WhatsAppIcon />
      <span className="max-w-[9rem] truncate text-xs sm:max-w-none sm:text-sm">Escríbenos</span>
    </a>
  );
}
